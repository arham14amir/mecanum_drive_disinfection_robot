...
: ${AMENT_CURRENT_PREFIX:="/home/arham/mecanum_drive_2/install/robot_hardware_interface"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_hardware_interface/environment/library_path.sh"
